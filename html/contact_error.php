    ...
    <section>
      <div class="container-contact">
        <div class="container-contact__box shadow">
          <img src="images/post-return.png" alt="スタンプ" class="post-error" width="300">
          <p class="p_error">
            大変申し訳ございません。内部エラーが発生しました<br>
            お手数ですが、時間をおいて再度お試しいただくか、メールにて直接お問い合わせください<br>
            hasuke8arusuke@gmail.com
          </p>
        </div>
          <div class="sns_done">
            <ul>
